...
<center>
<div style="align: center;" class="tab">
  <button class="tablinks" onclick="openCity(event, 'London')">
    <i class="fa fa-credit-card-alt fa-lg" aria-hidden="true"></i><br>To Pay</button>
  <button class="tablinks" onclick="openCity(event, 'Paris')">
    <i class="fa fa-truck fa-lg" aria-hidden="true"></i><br>To Pick Up</button>
  
  <button class="tablinks" onclick="openCity(event, 'Tokyo')">
    <i class="fa fa-shopping-cart" aria-hidden="true"></i><br>Completed</button>
        ...
        <div class="row">
          ...
          <div class="col-50">
            ...
            <div class="icon-container">
              <i class="fa fa-credit-card-alt" style="color:blue;" aria-hidden="true"></i>
              <i class="fa fa-credit-card-alt" aria-hidden="true" style="color:blue;"></i>
              <i class="fa fa-credit-card-alt" style="color:red;"></i>
