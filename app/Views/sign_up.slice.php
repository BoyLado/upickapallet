...
<head>
   ...
   <title>Sign Up | U Pick A Pallet</title>
...
<body class="layout-top-nav layout-navbar-fixed layout-fixed">
   <div class="wrapper">
      ...
      <aside class="control-sidebar control-sidebar-dark">
         <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12">dasdadsad</div>
            <div class="col-lg-6 col-md-12 col-sm-12">adadadadasd</div>
         </div>
      </aside>

      <input type="hidden" id="txt_baseUrl" name="txt_baseUrl" value="<?php echo base_url(); ?>">
